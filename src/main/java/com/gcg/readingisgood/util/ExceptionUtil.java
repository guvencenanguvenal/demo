...
import com.gcg.readingisgood.config.ErrorMessageConfig;
...
public class ExceptionUtil {
    ...
    @Autowired
    public ExceptionUtil(ErrorMessageConfig errorMessageConfig) {
        ExceptionUtil.errorMessageConfig = errorMessageConfig;
    }
    ...
    private static String format(String template, String... args) {
        Optional<String> templateContent = Optional.ofNullable(errorMessageConfig.getConfigValue(template));
